...
#+STARTUP: overview
#+LAST_EDITED: <2024-11-08 Fri 14:46>

* Table of Contents :toc:
:PROPERTIES:
:VISIBILITY: all
:END:
- [[#fix-fish-shell][Fix fish shell]]
- [[#dired][Dired]]
...
#+end_src
** Font
Choices: Commit Mono, Hack, IBM Plex Mono, Jetbrains Mono, Source Code Pro, Inconsolata, Raleway
#+begin_src elisp
(setq doom-font (font-spec :family "Hack" :size 24 :weight 'regular))
#+end_src
